...
moduleForAcceptance('[AGAT] Acceptance | i i s modul dlya chatbota ver2 анкетирование l');

test('testing i-i-s-modul-dlya-chatbota-ver2-анкетирование-l', function(assert) {
