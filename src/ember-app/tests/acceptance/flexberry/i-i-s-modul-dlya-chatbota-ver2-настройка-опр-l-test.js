...
moduleForAcceptance('[AGAT] Acceptance | i i s modul dlya chatbota ver2 настройка опр l');

test('testing i-i-s-modul-dlya-chatbota-ver2-настройка-опр-l', function(assert) {
