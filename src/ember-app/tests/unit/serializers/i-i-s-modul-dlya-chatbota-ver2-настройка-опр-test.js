...
moduleForModel('i-i-s-modul-dlya-chatbota-ver2-настройка-опр', 'Unit | Serializer | i-i-s-modul-dlya-chatbota-ver2-настройка-опр', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-modul-dlya-chatbota-ver2-настройка-опр',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
