...
moduleForModel('i-i-s-modul-dlya-chatbota-ver2-должность', 'Unit | Serializer | i-i-s-modul-dlya-chatbota-ver2-должность', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-modul-dlya-chatbota-ver2-должность',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
