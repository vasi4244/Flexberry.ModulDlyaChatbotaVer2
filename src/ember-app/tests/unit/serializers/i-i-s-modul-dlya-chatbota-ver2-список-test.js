...
moduleForModel('i-i-s-modul-dlya-chatbota-ver2-список', 'Unit | Serializer | i-i-s-modul-dlya-chatbota-ver2-список', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-modul-dlya-chatbota-ver2-список',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
