...
namespace IIS.Modul_dlya_chatbota_ver2
{
    ...
    [AssociatedDetailViewAttribute("НастройкаОпрE", "Содержание", "СодержаниеE", true, "", "Содержание", true, new string[] {
            ""})]
    [MasterViewDefineAttribute("НастройкаОпрE", "Опрос", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "Наименование")]
    [MasterViewDefineAttribute("НастройкаОпрE", "Сотрудники", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "Фамилия")]
    ...
    public class НастройкаОпр : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Modul_dlya_chatbota_ver2.Опрос fОпрос;
        
        private IIS.Modul_dlya_chatbota_ver2.Сотрудники fСотрудники;
        
        private IIS.Modul_dlya_chatbota_ver2.DetailArrayOfСодержание fСодержание;
        ...
        [PropertyStorage(new string[] {
                "Опрос"})]
        [NotNull()]
        public virtual IIS.Modul_dlya_chatbota_ver2.Опрос Опрос
        {
            get
            {
                ...
                IIS.Modul_dlya_chatbota_ver2.Опрос result = this.fОпрос;
        ...
        [PropertyStorage(new string[] {
                "Сотрудники"})]
        [NotNull()]
        public virtual IIS.Modul_dlya_chatbota_ver2.Сотрудники Сотрудники
        {
            get
            {
                ...
                IIS.Modul_dlya_chatbota_ver2.Сотрудники result = this.fСотрудники;
        ...
        public virtual IIS.Modul_dlya_chatbota_ver2.DetailArrayOfСодержание Содержание
        {
            get
            {
                ...
                {
                    this.fСодержание = new IIS.Modul_dlya_chatbota_ver2.DetailArrayOfСодержание(this);
                }
                IIS.Modul_dlya_chatbota_ver2.DetailArrayOfСодержание result = this.fСодержание;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View НастройкаОпрE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("НастройкаОпрE", typeof(IIS.Modul_dlya_chatbota_ver2.НастройкаОпр));
                }
            }
            ...
            public static ICSSoft.STORMNET.View НастройкаОпрL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("НастройкаОпрL", typeof(IIS.Modul_dlya_chatbota_ver2.НастройкаОпр));
                }
            }
        }
    }
