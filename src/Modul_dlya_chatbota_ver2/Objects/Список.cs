...
namespace IIS.Modul_dlya_chatbota_ver2
{
    ...
    public class Список : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Modul_dlya_chatbota_ver2.Анкетирование fАнкетирование;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Modul_dlya_chatbota_ver2.Анкетирование.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Анкетирование"})]
        public virtual IIS.Modul_dlya_chatbota_ver2.Анкетирование Анкетирование
        {
            get
            {
                ...
                IIS.Modul_dlya_chatbota_ver2.Анкетирование result = this.fАнкетирование;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СписокE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СписокE", typeof(IIS.Modul_dlya_chatbota_ver2.Список));
                }
            }
        }
    }
    ...
    public class DetailArrayOfСписок : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Modul_dlya_chatbota_ver2.DetailArrayOfСписок members)

        // *** End programmer edit section *** (IIS.Modul_dlya_chatbota_ver2.DetailArrayOfСписок members)
        ...
        /// </summary>
        public DetailArrayOfСписок(IIS.Modul_dlya_chatbota_ver2.Анкетирование fАнкетирование) : 
                base(typeof(Список), ((ICSSoft.STORMNET.DataObject)(fАнкетирование)))
        {
        }
        
        public IIS.Modul_dlya_chatbota_ver2.Список this[int index]
        {
            get
            {
                return ((IIS.Modul_dlya_chatbota_ver2.Список)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Modul_dlya_chatbota_ver2.Список dataobject)
        {
