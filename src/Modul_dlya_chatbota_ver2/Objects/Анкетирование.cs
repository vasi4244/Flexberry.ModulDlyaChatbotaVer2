...
namespace IIS.Modul_dlya_chatbota_ver2
{
    ...
    [View("АнкетированиеE", new string[] {
            "Дата as \'Дата\'",
            "Опрос as \'Опрос\'",
            "Опрос.Наименование as \'Наименование\'"}, Hidden=new string[] {
            "Опрос.Наименование"})]
    [AssociatedDetailViewAttribute("АнкетированиеE", "Список", "СписокE", true, "", "Список", true, new string[] {
            ""})]
    [MasterViewDefineAttribute("АнкетированиеE", "Опрос", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "Наименование")]
    [View("АнкетированиеL", new string[] {
            "Дата as \'Дата\'",
            "Опрос.Наименование as \'Наименование\'"})]
    public class Анкетирование : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Modul_dlya_chatbota_ver2.DetailArrayOfСписок fСписок;
        ...
        public virtual IIS.Modul_dlya_chatbota_ver2.DetailArrayOfСписок Список
        {
            get
            {
                ...
                {
                    this.fСписок = new IIS.Modul_dlya_chatbota_ver2.DetailArrayOfСписок(this);
                }
                IIS.Modul_dlya_chatbota_ver2.DetailArrayOfСписок result = this.fСписок;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View АнкетированиеE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("АнкетированиеE", typeof(IIS.Modul_dlya_chatbota_ver2.Анкетирование));
                }
            }
            ...
            public static ICSSoft.STORMNET.View АнкетированиеL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("АнкетированиеL", typeof(IIS.Modul_dlya_chatbota_ver2.Анкетирование));
                }
            }
        }
    }
